...
(function($){
    ...
    $(function(){
        ...
        $('.hero-info-inner, .book-now-btn, .book-now-btn').click(function(){

            $('.booking-modal-wrap').fadeIn(700);

        }) 

        $('.back-btn').click(function(){

            $('.booking-modal-wrap').fadeOut(700)
